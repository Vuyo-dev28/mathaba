      ...
      <div className="container">
        ...
        >
          <motion.div className="tag-wrapper" variants={itemVariants}>
            <span className="tag" style={{ borderColor: 'rgba(225, 29, 72, 0.5)', background: 'rgba(225, 29, 72, 0.15)' }}>Introducing Mathaba TL</span>
          </motion.div>

          <motion.h1 className="hero-title" variants={itemVariants}>
            Mathaba TL <br />
            <span className="text-gradient">Construction and Projects Solutions </span>
          </motion.h1>

          <motion.p className="hero-subtitle" variants={itemVariants}>
            <span className="text-red">Mathaba TL</span> is an emerging telecommunications provider, dedicated to offering high-quality, full turnkey solutions to businesses and organizations.
          </motion.p>
